...
def main():
    ...
    for inFile, all_res in ex:
        with open("analytics_" + inFile + ".csv", 'w') as csvfile:
            writer = csv.DictWriter(csvfile, fieldnames=["Algorithme", "Nombre de camions utilisés", "Nombre d'accès aux camions", "Moyenne de remplissage d'un camion",
                    "Camions remplis à 1-10%", "Camions remplis à 11-20%", "Camions remplis à 21-30%", "Camions remplis à 31-40%", "Camions remplis à 41-50%",
                    "Camions remplis à 51-60%", "Camions remplis à 61-70%", "Camions remplis à 71-80%", "Camions remplis à 81-90%", "Camions remplis à 91-100%"])
            writer.writeheader()
            for res in all_res:
                row = {}
